...
with(this){return _c('p',[_c('strong',[_v("Target user profile")]),_v(": Junior College Homeroom Teacher")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Efficient Contact Management: Provides quick access to student details for Junior College homeroom teachers.")]),_v(" "),_c('li',[_v("Smart Tagging System: Enables quick categorization and seamless student grouping based on academic strengths.")]),_v(" "),_c('li',[_v("Administrative Convenience: Reduces the hassle of managing student information and classroom interactions.")]),_v(" "),_c('li',[_v("Improved Efficiency: Streamlines administrative tasks, allowing teachers to focus more on student engagement.")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("JC Homeroom Teacher")]),_v(" "),_c('td',[_v("search for a student by name")]),_v(" "),_c('td',[_v("quickly retrieve their information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("JC Homeroom Teacher")]),_v(" "),_c('td',[_v("add a new contact")]),_v(" "),_c('td',[_v("keep track of their contact details efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("JC Homeroom Teacher")]),_v(" "),_c('td',[_v("delete a contact")]),_v(" "),_c('td',[_v("remove entries that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("JC Homeroom Teacher")]),_v(" "),_c('td',[_v("exit the program")]),_v(" "),_c('td',[_v("close the application when I am done using it")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JCRoster+")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JC Homeroom Teacher")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("JCRoster+ shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("JCRoster+ prompts the user to enter student details (name, phone number, email, address, and optional tags).")])]),_v(" "),_c('li',[_c('p',[_v("User enters the details in the specified format.")])]),_v(" "),_c('li',[_c('p',[_v("JCRoster+ validates the input.\n4.JCRoster+ adds the person to the address book and displays a success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. User enters an invalid name (contains numbers or special characters).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. JCRoster+ shows an error message: \"Numbers and special characters are not allowed.\"")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. User enters an invalid phone number (not numeric or outside 7-15 digits).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. JCRoster+ shows an error message: \"Phone number must contain only digits and be between 7 to 15 digits long.\"")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2c. User enters an invalid email (incorrect format).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. JCRoster+ shows an error message: \"Invalid email format. Please enter a valid email (e.g., "),_c('a',{attrs:{"href":"mailto:johndoe@example.com"}},[_v("johndoe@example.com")]),_v(").\"")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2d. User enters an invalid address (contains unsupported special characters).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2d1. JCRoster+ shows an error message: \"Invalid address format. Only letters, numbers, and basic punctuation are allowed.\"")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. A person with the same phone number already exists.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. JCRoster+ shows an error message: \"A person with this phone number already exists.\"")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("JCRoster+ prompts the user to enter a name or keyword to search.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the search query.")])]),_v(" "),_c('li',[_c('p',[_v("JCRoster+ searches the address book for matching names.")])]),_v(" "),_c('li',[_c('p',[_v("JCRoster+ displays a list of matching persons, if found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("JC Homeroom Teacher")]),_v(": Singapore Junior College Homeroom/Form Teachers")]),_v(" "),_c('li',[_c('strong',[_v("Student contact details")]),_v(": Refers to name, email, phone number, address")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Run it using the command 'java -jar jcroster+.jar' Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])]),_v(" "),_c('li',[_c('p',[_c('em',[_v("{ more test cases …​ }")])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Team Size:")]),_v(" 4")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"1-ui-enhancement-full-visibility-of-command-guide-panel"}},[_v("1. UI Enhancement – Full Visibility of Command Guide Panel"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-ui-enhancement-full-visibility-of-command-guide-panel","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Fri, 4 Apr 2025, 13:37:06 GMT+8]")])])])}
}];
