...
public class CommandTestUtil {
    ...
    public static final String VALID_GRADES_BOB = "Math:A,Science:A,English:A,History:C,Geography:B,Music:A";
    ...
    public static final String INVALID_GRADE_DESC = " " + PREFIX_GRADE
            + "Math:A,Science:A,English:G,History:C,Geography:B,Music:A";
